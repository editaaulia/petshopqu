...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark shadow-sm p-3 fixed-top" style="background-color: #F5D14B;">
        <div class="container">
            <a class="navbar-brand" href="dashboard.html"><img src="templates/img/logo.png" alt="" width="30" height="30" class="d-inline-block align-text-top"> PETSHOPQU</a>
            ...
            <div class="header">
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="dashboard.html">BERANDA</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="profil.html">TENTANG KAMI</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <a class="dropdown-item" href="register.html">REGISTER</a></li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="../auth/logout.html">LOGOUT</a>
                        </li>
                    </ul>
                    </div>
                </div>
